...
public class Aresta {
    ...
    public Aresta(VectorR2 v1, VectorR2 v2) {
        this.v1 = v1;
        this.v2 = v2;

        if (v1.getY() > v2.getY())
        {
            VectorR2 tmp = this.v1;
            this.v1 = this.v2;
            this.v2 = tmp;
        }
    }
    ...
    {
        List<VectorR2> puntsSegments = new LinkedList<>();
        VectorR2 comu;
        // Afegim tots els VectorR2 i despres eliminem el VectorR2 comú
